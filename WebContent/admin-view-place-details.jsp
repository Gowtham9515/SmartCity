...
<head>
<meta charset="utf-8">
<title>Smart City || View Places</title>
...
<body>
	...
	<div class="container-xxl py-5">
		<div class="container-fluids">
			...
			%>
			<div class='alert alert-warning' id="warning">Place info updated
				successfully.</div>
			<%
				}
			%>
				...
				<div class="panel-body">
					<table class="table table-bordered">
						...
						<tr>
							...
							<td><a href="admin-edit-place-details.jsp?pid=<%=resultset.getString("pid")%>"
