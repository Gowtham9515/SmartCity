...
<head>
<meta charset="utf-8">
<title>Smart City || View Feedbacks</title>
				...
				<div class="panel-body">
					<table class="table table-bordered">
						...
						<tr>
							...
							<td>
								<%
									if (resultset.getString("utype").equals("Job Seeker")) {
								%> 
									<font color="blue"><strong>Job Seeker</strong></font></span> 
								<%
 									} else if (resultset.getString("utype").equals("Student")){
 								%> 
							...
							<td><font color="orange"><%=resultset.getString("feedback")%></font></td>
