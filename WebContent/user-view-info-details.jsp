...
<head>
<meta charset="utf-8">
<title>Smart City || View Info</title>
			...
			<div class="panel panel-warning shadow p-3 mb-5">
				<div class="panel-body">
					<table class="table table-bordered">
						...
						<%
							int count = 0;
							ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblplaces where state='"+ request.getParameter("stt") + "' and city='" + request.getParameter("city") + "' and category='"+request.getParameter("category")+"'");
