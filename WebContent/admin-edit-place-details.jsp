...
<head>
<meta charset="utf-8">
<title>Smart City || Edit Place Details</title>
	...
	<div class="container-xxl py-5">
		<div class="container">
			...
			<%
				...
				ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblplaces where pid='" + pid + "'");
				if (resultset.next()) {
			%>
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="panel panel-primary shadow p-3 mb-5">
						<div class="panel-heading text-center">Edit Place</div>
						<div class="panel-body">
							<form action="AdminEditPlace" method="post" enctype="multipart/form-data">
								<div class="row g-3">
									<div class="col-md-12">
									...
									<div class="col-md-12">
										<label for="place">Place Name</label><input type="text"
											...
											value="<%=resultset.getString("place")%>" required>
									</div>
									<div class="col-md-12">
										<label for="state">State</label><input type="text"
											class="form-control" name="state" id="state" value="<%=resultset.getString("category")%>"
											readonly>
									</div>
									<div class="col-md-12">
									...
									<div class="col-md-12">
										...
										<textarea name="description" id="description"
											class="form-control" placeholder="Description" required><%=resultset.getString("description")%></textarea>
									</div>
									<div class="col-md-12">
									...
									<div class="col-md-12">
										<input type="submit" value="Update Info"
											...
											onclick="return confirm('Are you sure Do you want to edit this place?');">
