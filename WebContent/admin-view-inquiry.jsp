...
<head>
<meta charset="utf-8">
<title>Smart City || View Inquiries</title>
...
<body>
	...
	<div class="container-xxl py-5">
		<div class="container-fluids">
			...
			<%
				String message = (String) session.getAttribute("mail-success");
				if (message != null) {
					session.removeAttribute("mail-success");
			%>
			<div class='alert alert-success' id='success'>Reply send
				successfully.</div>
			<%
				}
			%>
				...
				<div class="panel-body">
					<table class="table table-bordered">
						...
						<tr>
							...
							%>
							<td><div class="label label-success">Replied</div></td>
							<%
								}
							%>
							...
							%>
							<td><a
								href="admin-give-inquiry-reply.jsp?contactId=<%=resultset.getInt("contact_id")%>"
								class="btn btn-info">Give Reply</a></td>
							<%
								}
							%>
						</tr>
