...
<head>
<meta charset="utf-8">
<title>Smart City || Add Places</title>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<img src="img/add-places.png" style="width: 350px; height: 300px;"></img>
				</div>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<%
					...
					%>
					<div class='alert alert-success' id="success">Place added successfully.</div>
					<%
						}
					%>
					<%
					...
					%>
					<div class='alert alert-danger' id="danger">Place already
						exist.</div>
					<%
						}
					%>
					<div class="panel panel-primary shadow p-3 mb-5">
						<div class="panel-heading text-center">Add Places</div>
						<div class="panel-body">

							<form action="admin-add-places-details.jsp" method="post">
								<div class="row g-3">
									<div class="col-md-12">
