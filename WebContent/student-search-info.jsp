...
<head>
<meta charset="utf-8">
<title>Smart City || Search Info</title>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<img src="img/search-info.jpg" style="width: 450px; height: 350px;"></img>
				</div>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="panel panel-primary shadow p-3 mb-5">
						<div class="panel-heading text-center">Search Info</div>
						<div class="panel-body">

							<form action="student-search-info-details.jsp" method="post">
								<div class="row g-3">
									<div class="col-md-12">
