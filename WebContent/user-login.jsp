...
<head>
<meta charset="utf-8">
<title>Smart City || User Login</title>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<img src="img/user-login.jpg" style="width: 550px; height: 400px;"></img>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12">
						...
						<form action="UserLogin" method="post">
							<div class="row g-3">
								...
								<div class="col-md-12">
									...
									<a href="user-account.jsp">Click here to new account</a> || <a
										href="user-forgot-password.jsp">Forget Password?</a>
								</div>
							</div>
						</form>
					</div>
