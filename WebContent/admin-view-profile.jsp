		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<img src="img/my-profile.jpg" style="width: 500px; height: 400px;">
				</div>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="panel panel-warning shadow p-3 mb-5">
						<div class="panel-heading text-center">View Profile</div>
							...
							<div class="row g-3">
								<div class="col-md-12">
									<label for="adminId">Admin Id</label> <input type="text"
										...
										name="adminId" value="<%=resultset.getInt("adminId")%>"
										readonly>
								</div>
								<div class="col-md-12">
								...
								<div class="col-md-12">
									<label for="uname">User Name</label> <input type="text"
										...
										name="uname" value="<%=resultset.getString("uname")%>"
										readonly>
								</div>
								<div class="col-md-12">
									<label for="upass">Password</label> <input type="password"
										class="form-control" id="upass" placeholder="Password"
										name="uname" value="<%=resultset.getString("upass")%>"
										readonly>
								</div>
								<div class="col-md-12">
