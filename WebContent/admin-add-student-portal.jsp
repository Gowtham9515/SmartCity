...
<head>
<meta charset="utf-8">
<title>Smart City || Add Student Information</title>
			...
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line">
						<strong>Student Portal Details</strong>
					</h4>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<img src="img/student-portal.JPG" style="width: 450px; height: 350px;"></img>
				</div>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<%
					...
					%>
					<div class='alert alert-success' id="success">Place info added successfully.</div>
					<%
						}
					%>
					<%
					...
					%>
					<div class='alert alert-danger' id="danger">Place info already
						exist.</div>
					<%
						}
					%>
					<div class="panel panel-primary shadow p-3 mb-5">
						<div class="panel-heading text-center">Add Student Portal Details</div>
						<div class="panel-body">

							<form action="admin-add-student-portal-details.jsp" method="post">
								<div class="row g-3">
									<div class="col-md-12">
