...
/**
 * Servlet implementation class EditJobSeekerProfile
 */
@WebServlet("/EditJobSeekerProfile")
public class EditJobSeekerProfile extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(editProfile>0) {
				...
				response.sendRedirect("jobseeker-view-profile.jsp");
			}
		}catch(Exception e) {
			e.printStackTrace();
		}
